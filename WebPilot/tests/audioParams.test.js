/**
 * Contract guard for the web audio path: the contract IDs the pilot can reach
...
import {
  ...
  gpFieldsFromState,
  defaultGpFields,
} from '../lib/audioParams.js';
import { getDescriptor } from '../lib/parameters.js';
import { fromNormalized } from '../lib/parameters.js';
