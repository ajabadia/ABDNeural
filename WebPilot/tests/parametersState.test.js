/**
 * Tests for the contract-state helpers in lib/parameters.js: default state
 * seeding, state validation (the pilot footer makes these errors visible) and
 * the divergent-parameter report. The value math (to/fromNormalized) is already
...
describe('validateState', () => {
  it('passes a state seeded by defaultState for the pilot screen', () => {
...
describe('describeControl / divergences', () => {
  ...
  it('summarises the pilot screen against the contract', () => {
