...
//==============================================================================
// Helpers de JUCE usados por AudioBuffer (juce_core/system/juce_StandardHeader.h)

/** Handy function for getting the number of elements in a const array.
    Port literal de juce::numElementsInArray. */
template <typename Type>
constexpr int numElementsInArray (Type array) noexcept
{
    constexpr int numElements = sizeof (array) / sizeof (array[0]);
    return numElements;
}
